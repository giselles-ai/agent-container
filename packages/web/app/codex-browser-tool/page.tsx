	...
	return (
		<div className="mx-auto max-w-3xl rounded-2xl border border-slate-700/60 bg-slate-900/50 p-6 shadow-2xl backdrop-blur">
			<p className="text-xs uppercase tracking-[0.18em] text-orange-300/80">
				Giselle Browser Tool Agent (Codex)
			</p>
			...
			<p className="mt-3 text-sm text-slate-300/90">
				...
				execution, powered by <strong>Codex</strong>.
			</p>
			...
			>
				<div>
					...
					<input
						...
						className="w-full rounded-xl border border-slate-700 bg-slate-950/70 px-3 py-2 text-sm text-slate-100 outline-none focus:border-orange-400"
					/>
				</div>
				...
				<label className="flex items-center gap-2 text-sm text-slate-200">
					<input
						...
						className="h-4 w-4 rounded border-slate-500 bg-slate-950 text-orange-400"
					/>
					Publish immediately
				</label>
			</form>
...
export default function CodexBrowserToolPage() {
				...
				<div className="rounded-2xl border border-slate-700 bg-slate-950/90 p-4">
					...
					<label className="mb-3 block">
						...
						<textarea
							...
							className="w-full rounded-lg border border-slate-700 bg-slate-900/90 px-3 py-2 text-sm text-slate-100 outline-none focus:border-orange-400"
						/>
					</label>
					...
					<form className="mt-3 flex gap-2" onSubmit={handleSubmit}>
						<input
							...
							className="flex-1 rounded-lg border border-slate-700 bg-slate-900/90 px-3 py-2 text-sm text-slate-100 outline-none focus:border-orange-400"
						/>
						<button
							type="submit"
							disabled={!input.trim() || isBusy}
							className="rounded-lg bg-orange-400 px-3 py-2 text-sm font-semibold text-slate-950 transition hover:bg-orange-300 disabled:cursor-not-allowed disabled:opacity-50"
						>
							{isBusy ? "Running..." : "Send"}
						</button>
					</form>
